...
#define VOLTAGE_PEAK 6.0 // [V] Power supply voltage (Peak)
#define SPEED_MAX 71.471  // [cm/s] Max speed of robot (measured)
#define TIME_TO_STOP 0.615  // [s] Time to stop with null input starting from max speed (measured)
...
// Noise
#define NOISE_PROCESS_POSITION_STD 0.1  // [cm] Standard deviation of process noise for position
#define NOISE_PROCESS_VELOCITY_STD 0.1  // [cm/s] Standard deviation of process noise for velocity
